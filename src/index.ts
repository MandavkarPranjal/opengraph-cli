...
Usage:
  og-preview <url>              Fetch and display OpenGraph metadata from a URL
  og-preview --help, -h         Show this help message

Examples:
  og-preview https://example.com
  og-preview http://localhost:3000
